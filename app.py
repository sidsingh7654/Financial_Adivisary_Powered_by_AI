...
data['Debt_Allocation'] = (
    ...
    (5 - data['Investment_Horizon']) * 5 +  # Shorter horizon → more debt
    (100 - data['Savings_Rate']*100) * 0.1 +  # Lower saving rate → prefer safer assets
    np.random.normal(0, 1.5, len(data))
).clip(0, 100)
...
print("✅ Stage 3 Dataset Saved: Stage3_Dynamic_Products.csv")
...
print("🔵 Recommended Stocks (Equity):")
